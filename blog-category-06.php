...
$pdoQ='select   * from article ORDER BY dateCreation DESC  '; 
...
<body>
    ...
    <div id="wrapper">
        ...
        <header class="header">
           ...
           <a  class="nav-link" href="visite.php?categorie=<?php echo $output['categorie'] ?>" name="categorie">   
                  ...
                  <?php  endforeach; ?>
                            ...
                            <!-- <li class="nav-item">
                                <a class="nav-link active color-grey-hover" href="blog-category-06.php">Acceuil</a>
                            </li> -->
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link color-red-hover" href="blog-category-05.php"> Economie</a>
                            </li>
        ...
        <div class="page-title wb" style="background-image: url'https://mdn.mozillademos.org/files/6457/mdn_logo_only_color.png');">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        <h2><i class="fa fa-user-md bg-grey"></i> Nouveauté </h2>
                    </div><!-- end col -->
                    ...
                    <div class="col-xl-12 col-xl-12 col-xl-12 col-xl-12">
                        <div class="page-wrapper">
                            <div class="portfolio row">
                                        ...
                                        <div class="post-media">
                                            ...
                                            <?php
                                                 $code =  substr($art->lien,32); ?>
                                                    ...
                                                    mozallowfullscreen="true" frameborder="0" height="200px" width="100%">
                                                    </iframe>
                                ...
                                <a  class="nav-link" href="visite.php?categorie=<?php echo $art->categorie ?>" name="categorie">   
                                <?= $art->categorie ; ?>
                                </a>
                            </span>
                                            ...
                                            <small><a href="blog-category-01.html" title=""><?= $art->dateCreation ; ?> </small>
                                        </div>
                                    </div>
