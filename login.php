                    ...
                    <div class="col-lg-4 hidden-md-down">
                        <div class="topmenu text-center">
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item"><a href="page-contact.html"><i class="fa fa-user-circle-o"></i><b>se connecter </b></a></li>
                            </ul><!-- end ul -->
                        </div><!-- end topmenu -->
                    </div><!-- end col -->
                ...
                <nav class="navbar navbar-inverse navbar-toggleable-md">
                    ...
                    <div class="collapse navbar-collapse justify-content-md-center" id="cloapediamenu">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link color-yellow-hover" href="blog-category-05.php"><i class="fa fa-play-circle-o"></i> Vidéo</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link color-grey-hover" href="blog-category-06.php">Accueil</a>
                            </li>
                        </ul>
                    </div>
                </nav>
                            ...
                            <div class="row-center">
                                <div class="col-lg-10">
                                    <form class="form-wrapper" method="POST" action="register.php">
                                        ...
                                        <button type="submit" class="btn btn-success" name="submit">créér  </button>
                                    </form>
                                </div>
                            </div>
