...
$pdoQ="SELECT * FROM article WHERE categorie='$categorie'"; 
                ...
                <div class="row">
                        ...
                        <div class="page-wrapper">
                            ...
                            <?php foreach($article as $art):  ?>
                                ...
                                <div class="post-sharing">
                                    <ul class="list-inline">
                                        <li><a href="https://www.facebook.com/profile.php?id=100013304561813" class="fb-button btn btn-primary"><i class="fa fa-facebook"></i> <span class="down-mobile">Partager sur Facebook</span></a></li>
                                        <li><a href="https://twitter.com/messages/compose" class="tw-button btn btn-primary"><i class="fa fa-twitter"></i> <span class="down-mobile">Tweeter sur Twitter</span></a></li>
                 ...
                 <iframe 
                     src="https://www.youtube.com/embed/<?= $code ?>" 
                         title="<?= $art->titre; ?>" 
                         scrolling="no" marginwidth="0" marginheight="100%" allowfullscreen="true"
                          ...
                          height="380px" width="800px">
                            ...
                            <div class="blog-content">  
                                <div class="pp">
                                    <p style="size:40px;"><?= $art->description; ?></p>
                        ...
                        <div class="sidebar">
                            ...
                            <div class="widget">
                                ...
                                <ul>  
                                        ...
                                        <?php foreach ($resultat as $output) {?>
                                    <li> 
                                        <a  class="nav-link" href="visite.php?categorie=<?php echo $output['categorie'] ?>" name="categorie"> <b><?php echo $output["categorie"] ;?>   </b>  </a>
                                        </li>
                                        <?php } ?> 
                                        </ul>
